...
export const DoserContextProvider = ({children}) => {
    const [selectedIngredient, setSelectedIngredient] = useState<Ingredient>(defaultValue.selectedIngredient)
    const [nbPersonnes, setNbPersonnes] = useState<number>(defaultValue.nbPersonnes)
